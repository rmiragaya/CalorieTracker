    ...
    Box(
        ...
        Column(
            ...
            UnitTextField(
                ...
                onValueChange = {
                    viewModel.onEvent(NutrientGoalEvent.OnCarbRatioEvent(it))
                },
            ...
            UnitTextField(
                ...
                onValueChange = {
                    viewModel.onEvent(NutrientGoalEvent.OnProteinRatioEvent(it))
                },
            ...
            UnitTextField(
                ...
                onValueChange = {
                    viewModel.onEvent(NutrientGoalEvent.OnFatRatioEvent(it))
                },
